...
The AbeLib library is a general purpose actionscript library. This library contains four distinct parts : 

* The abe.com.mon and abe.com.p
atibility packages contains all the general utilities, interfaces and classes used by the rest of the library. In abe.com.patibility you can find all the codecs and the gettext implementation used by the rest of the library.
