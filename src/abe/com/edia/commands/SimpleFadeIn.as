...
package abe.com.edia.commands 
{
	 ...
	 */
	public class SimpleFadeIn extends AbstractCommand implements Command, Runnable, Suspendable, ImpulseListener
	{
		...
		public function SimpleFadeIn ( level : DisplayObjectContainer, 
									   color : Color = null, 
		...
		public function tick (e : ImpulseEvent) : void
		{
			...
			_shape.alpha = _easing( _t, 1, -1, _fadeDuration );
