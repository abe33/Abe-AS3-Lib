package abe.com.edia.particles.recorders
{
     ...
     * @author cedric
     */
    public class EmissionsRecorder implements Recorder, ImpulseListener
    {
        ...
        public function EmissionsRecorder ( manager : ParticleManager, valuesRange : Range = null, curveSettings : GraphCurveSettings = null )
        {
            _manager = manager;
            Impulse.register( tick );
			
			this._values = new Array();
			this._valuesRange = valuesRange ? valuesRange : new Range(0,100);
			this._curveSettings = curveSettings ? 
										curveSettings : 
										new GraphCurveSettings( _("Emissions"), Color.FireBrick, 0 );
        }
        ...
        public function get unit () : String { return _("emissions"); }

        public function tick ( bias : Number, biasInSeconds : Number, currentTime : Number ) : void
        {
            _values.push( _manager.emissionsCount );
