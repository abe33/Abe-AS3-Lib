package abe.com.edia.particles.strategy.actions
{
	...
	public class PonctualForceActionStrategy extends AbstractActionStrategy implements ActionStrategy
	{
		...
		{
			var pForce : Point = particle.position.subtract( _forcePosition );
			var distLength : Number = pForce.length;
			
			if( distLength > _forceRadius ) return;
			
			var l : Number = _forceStrength * _forceDecay( distLength / _forceRadius ) * _nTimeStep;
