...
package  abe.com.ponents.skinning.cursors
{
	...
	public class Cursor extends Sprite
	{
		...
		{
			createDefaultCursor( RESIZE_E, 	CURSOR_RESIZE_EAST, 		new Point( 18,  12 	) );			createDefaultCursor( RESIZE_W, 	CURSOR_RESIZE_WEST,  		new Point( 4,  	12 	) );			createDefaultCursor( RESIZE_N, 	CURSOR_RESIZE_NORTH,  		new Point( 12,  4 	) );			createDefaultCursor( RESIZE_S, 	CURSOR_RESIZE_SOUTH,  		new Point( 12,  18 	) );			createDefaultCursor( RESIZE_NE,	CURSOR_RESIZE_NORTH_EAST,   new Point( 18,  4 	) );			createDefaultCursor( RESIZE_SE, CURSOR_RESIZE_SOUTH_EAST,   new Point( 18,  18 	) );			createDefaultCursor( RESIZE_NW, CURSOR_RESIZE_NORTH_WEST,   new Point( 4,  	4	) );			createDefaultCursor( RESIZE_SW, CURSOR_RESIZE_SOUTH_WEST,   new Point( 4,  	18	) );			createDefaultCursor( DRAG,  	CURSOR_DRAG,  				new Point( 12, 	12 	) );			createDefaultCursor( DRAG_H, 	CURSOR_DRAG_HORIZONTAL, 	new Point( 12, 	12 	) );			createDefaultCursor( DRAG_V,  	CURSOR_DRAG_VERTICAL,  		new Point( 12, 	12 	) );
