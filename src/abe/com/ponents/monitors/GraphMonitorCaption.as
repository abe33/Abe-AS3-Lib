package abe.com.ponents.monitors
{
    ...
    public class GraphMonitorCaption extends Panel implements Suspendable, ImpulseListener
    {
        ...
        public function GraphMonitorCaption ( monitor : GraphMonitor, captionMode : uint = 0, layoutMode : uint = 0 )
        {
            ...
            TARGET::FLASH_10_1 { var rcd : Vector.<Recorder> = _monitor.recorders; } 
        ...
        FEATURES::MENU_CONTEXT { 
            ...
            protected function createContextMenuItems () : void
            {
                ...
                addNewContextMenuItemForGroup( getContextMenuItemCaption(_captionMode), 
                                               "captionMode", 
                                               switchCaptionMode, 
                                               "captionModes" );
                ...
                _cmis.push( addNewContextMenuItemForGroup( 
                                ContextMenuItemUtils.getBooleanContextMenuItemCaption(  _("Flow layout"), 
                                                                                        isLayoutModeSelected( 0 ) ),
                                "flowLayout", 
                                switchLayoutMode, 
                                "layoutModes" ) );

                _cmis.push( addNewContextMenuItemForGroup( 
                                ContextMenuItemUtils.getBooleanContextMenuItemCaption(  _("1 column layout"), 
                                                                                        isLayoutModeSelected( 1 ) ),
                                "1columnLayout", 
                                switchLayoutMode, 
                                "layoutModes" ) );

                _cmis.push( addNewContextMenuItemForGroup( 
                                ContextMenuItemUtils.getBooleanContextMenuItemCaption(  _("2 column layout"), 
                                                                                        isLayoutModeSelected( 2 ) ),
                                "2columnLayout", 
                                switchLayoutMode, 
                                "layoutModes" ) );

                _cmis.push( addNewContextMenuItemForGroup( 
                                ContextMenuItemUtils.getBooleanContextMenuItemCaption(  _("3 column layout"), 
                                                                                        isLayoutModeSelected( 3 ) ),
                                "3columnLayout", 
                                switchLayoutMode, 
                                "layoutModes" ) );

                _cmis.push( addNewContextMenuItemForGroup( 
                                ContextMenuItemUtils.getBooleanContextMenuItemCaption(  _("4 column layout"), 
                                                                                        isLayoutModeSelected( 4 ) ),
                                "4columnLayout", 
                                switchLayoutMode, 
                                "layoutModes" ) );

                _cmis.push( addNewContextMenuItemForGroup( 
                                ContextMenuItemUtils.getBooleanContextMenuItemCaption(  _("5 column layout"), 
                                                                                        isLayoutModeSelected( 5 ) ),
                                "5columnLayout", 
                                switchLayoutMode, 
                                "layoutModes" ) );
            }
            ...
            {
                _cmis[ 0 ].caption = ContextMenuItemUtils.getBooleanContextMenuItemCaption( _("Flow layout"),
                                                                                            isLayoutModeSelected( 0 ) );
                _cmis[ 1 ].caption = ContextMenuItemUtils.getBooleanContextMenuItemCaption( _("1 column layout"), 
                                                                                            isLayoutModeSelected( 1 ) ); 
                _cmis[ 2 ].caption = ContextMenuItemUtils.getBooleanContextMenuItemCaption( _("2 column layout"), 
                                                                                            isLayoutModeSelected( 2 ) );
                _cmis[ 3 ].caption = ContextMenuItemUtils.getBooleanContextMenuItemCaption( _("3 column layout"), 
                                                                                            isLayoutModeSelected( 3 ) );
                _cmis[ 4 ].caption = ContextMenuItemUtils.getBooleanContextMenuItemCaption( _("4 column layout"), 
                                                                                            isLayoutModeSelected( 4 ) );
                _cmis[ 5 ].caption = ContextMenuItemUtils.getBooleanContextMenuItemCaption( _("5 column layout"), 
                                                                                            isLayoutModeSelected( 5 ) );
            }
        ...
        {
            monitor.recorderAdded.add( recorderAdded );
            monitor.recorderRemoved.add( recorderRemoved );
        }
        protected function unregisterFromMonitorEvents (monitor : GraphMonitor) : void 
        {
            monitor.recorderAdded.remove( recorderAdded );
            monitor.recorderRemoved.remove( recorderRemoved );
        }
        protected function recorderAdded ( monitor : GraphMonitor, rec : Recorder, index : int ) : void 
        {
            var cl : CaptionLabel = new CaptionLabel( formatLabel( rec ), new ColorIcon( rec.curveSettings.color ) ) ;
            cl.tooltip = rec.curveSettings.name;
            addComponent( cl );
        }
        protected function recorderRemoved ( monitor : GraphMonitor, rec : Recorder, index : int ) : void 
        {
