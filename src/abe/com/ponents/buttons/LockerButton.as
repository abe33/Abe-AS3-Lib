...
package abe.com.ponents.buttons 
{
	...
	[Skin(define="LockerButton",
		  ...
		  preview="abe.com.ponents.buttons::LockerButton.defaultLockerButtonPreview",  
		  custom_checkedIcon="icon(abe.com.ponents.buttons::LockerButton.CHECKED_ICON)",
		  custom_uncheckedIcon="icon(abe.com.ponents.buttons::LockerButton.UNCHECKED_ICON)"
	)]
	/**
