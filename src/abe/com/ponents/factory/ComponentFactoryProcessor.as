package abe.com.ponents.factory 
{
	 ...
	 *  
	 * @eventType abe.com.ponents.events.ComponentFactoryEvent.BUILD_START
	 */
	[Event(name="buildStart",type="abe.com.ponents.events.ComponentFactoryEvent")]
	/**
	 * Évènement diffusé lors de la fin de la construction des composants.
	 *  
	 * @eventType abe.com.ponents.events.ComponentFactoryEvent.BUILD_COMPLETE
	 */
	[Event(name="buildComplete",type="abe.com.ponents.events.ComponentFactoryEvent")]
	/**
	 * Évènement diffusé durant la construction des composants.
	 *  
	 * @eventType abe.com.ponents.events.ComponentFactoryEvent.BUILD_PROGRESS
	 */
	[Event(name="buildProgress",type="abe.com.ponents.events.ComponentFactoryEvent")]
	/**
