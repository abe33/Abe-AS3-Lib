package abe.com.ponents.containers 
{
    ...
    public class MultiSplitPane extends DropPanel implements DropTarget
    {
        ...
        public var weightChanged : Signal;
        
        public function MultiSplitPane ()
        {
            super( true );
            weightChanged = new Signal();
        ...
        {
            if( ComponentsFlavors.COMPONENT.isSupported( transferable.flavors ) )
        ...
        override public function dragOver ( manager : DnDManager, transferable : Transferable, source : DragSource ) : void
        {
            ...
            var nc : Component = transferable.getData( ComponentsFlavors.COMPONENT );
            if( c && c != nc )
                handleDragOver(c);
        }
