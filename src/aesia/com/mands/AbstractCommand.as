...
package  aesia.com.mands
{
	 ...
	 * 
	 * @eventType aesia.com.mands.events.CommandEvent.COMMAND_END
	 */
	[Event(name="commandEnd", type="aesia.com.mands.events.CommandEvent")]
	
	/**
	 * Diffusé par la commande en cas d'échec de son processus.
	 * 
	 * @eventType aesia.com.mands.events.CommandEvent.COMMAND_FAIL
	 */
	[Event(name="commandFailed", type="aesia.com.mands.events.CommandEvent")]
