...
package  aesia.com.mands
{
	...
	import aesia.com.mands.events.LoopEvent;
	 ...
	 * 
	 * @eventType	aesia.com.mands.events.LoopEvent.LOOP_START
	 */
	[Event(name="loopStart", type="aesia.com.mands.events.LoopEvent")]
	
	/**
	 * Diffusé en cas d'arrêt de la boucle suite à l'appel de la
	 * méthode <code>stop</code>.
	 * 
	 * @eventType	aesia.com.mands.events.LoopEvent.LOOP_STOP
	 */
	[Event(name="loopStop", type="aesia.com.mands.events.LoopEvent")]
	
	/**
	 * Diffusé à chaque série d'itérations.
	 * 
	 * @eventType	aesia.com.mands.events.LoopEvent.LOOP_PROGRESS
	 */
	[Event(name="loopProgress", type="aesia.com.mands.events.LoopEvent")]
