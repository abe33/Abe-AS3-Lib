...
package aesia.com.motion
{
	...
	import aesia.com.motion.properties.SpecialProperty;
	 ...
	 *
	 * @eventType aesia.com.motion.TweenEvent.TWEEN_START
	 */
	[Event(name="tweenStart", type="aesia.com.motion.TweenEvent")]
	/**
	 * Évènement diffusé lors de l'arrêt de l'interpolation.
	 *
	 * @eventType aesia.com.motion.TweenEvent.TWEEN_STOP
	 */
	[Event(name="tweenStop", type="aesia.com.motion.TweenEvent")]
	/**
	 * Évènement diffusé à chaque étape de l'interpolation .
	 *
	 * @eventType aesia.com.motion.TweenEvent.TWEEN_CHANGE
	 */
	[Event(name="tweenChange", type="aesia.com.motion.TweenEvent")]
	/**
	 * Évènement diffusé lors de la fin de l'interpolation.
	 *
	 * @eventType aesia.com.motion.TweenEvent.TWEEN_START
	 */
	[Event(name="tweenEnd", type="aesia.com.motion.TweenEvent")]
	/**
