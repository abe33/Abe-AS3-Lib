 ...
 */
package aesia.com.ponents.tools.prettify
{
	...
	public class GPrettify
	{
        ...
        // removed
        public function prettyPrintOne(sourceCodeHtml:String, opt_langExtension:String=null, buildHTML:Boolean=false):String
        {
            try {
