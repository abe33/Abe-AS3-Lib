...
{
	import aesia.com.mon.geom.ClosedGeometry;
	import aesia.com.mon.geom.Ellipsis;
	...
	import aesia.com.ponents.nodes.events.CanvasNodeEvent;
	import aesia.com.ponents.nodes.renderers.nodes.NodeRendererFactoryInstance;
	...
	public class CanvasNode extends Panel implements CanvasElement
	{
		...
		public function CanvasNode ( userObject : * = null )
		{
			...
			TARGET::FLASH_10_1 { /*FDT_IGNORE*/
			_connections = new Vector.<NodeLink>(); /*FDT_IGNORE*/ } /*FDT_IGNORE*/
			
			doubleClickEnabled = true;
			
			/*FDT_IGNORE*/ FEATURES::MENU_CONTEXT { /*FDT_IGNORE*/
			addNewContextMenuItemForGroup(_("Edit content properties"), "properties", editObjectProperties, "objects", -1, true );
		...
		public function addConnection( link : NodeLink ) : void
		{
			...
			dispatchEvent( new CanvasNodeEvent(CanvasNodeEvent.CONNECTION_ADD, this, link.b, link, true, true ));
		}
		public function removeConnection( link : NodeLink ):void
		{
			...
			dispatchEvent( new CanvasNodeEvent(CanvasNodeEvent.CONNECTION_REMOVE, this, link.b, link, true, true ));
		}
		public function removeConnectionsWith( o : CanvasNode ):void
		{
			...
			dispatchEvent( new CanvasNodeEvent(CanvasNodeEvent.CONNECTION_REMOVE, this, o, a, true, true ));
		}
