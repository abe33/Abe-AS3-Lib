package aesia.com.ponents.containers 
{
	...
	import aesia.com.ponents.layouts.components.SplitPaneLayout;
...
[Skin(define="SplitPane_Expander",
		  ...
		  custom_upIcon="icon(aesia.com.ponents.containers::SplitPane.EXPAND_UP_ICON)",		  custom_downIcon="icon(aesia.com.ponents.containers::SplitPane.EXPAND_DOWN_ICON)",		  custom_leftIcon="icon(aesia.com.ponents.containers::SplitPane.EXPAND_LEFT_ICON)",		  custom_rightIcon="icon(aesia.com.ponents.containers::SplitPane.EXPAND_RIGHT_ICON)"
)]
