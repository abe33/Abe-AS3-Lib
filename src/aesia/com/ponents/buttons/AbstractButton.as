...
package aesia.com.ponents.buttons
{
	 ...
	 *
	 * @eventType aesia.com.ponents.events.ActionEvent.ACTION
	 */
	[Event(name="action", type="aesia.com.ponents.events.ActionEvent")]	/**
	 * Évènement diffusé par l'instance au moment du déclenchement du click du bouton.
	 *
	 * @eventType aesia.com.ponents.events.ButtonEvent.BUTTON_CLICK
	 */
	[Event(name="buttonClick", type="aesia.com.ponents.events.ButtonEvent")]	/**
	 ...
	 * </p>
	 *
	 * @eventType aesia.com.ponents.events.ButtonEvent.BUTTON_DBLE_CLICK
	 */
	[Event(name="buttonDbleClick", type="aesia.com.ponents.events.ButtonEvent")]	/**
	 * Évènement diffusé par l'instance lorsque le bouton de la souris est relâchée
	 * en dehors du composant.
	 *
	 * @eventType aesia.com.ponents.events.ButtonEvent.BUTTON_RELEASE_OUTSIDE
	 */
	[Event(name="buttonReleaseOutside", type="aesia.com.ponents.events.ButtonEvent")]	/**
	 * Évènement diffusé lorsque l'état de sélection du composant à changer.
	 *
	 * @eventType aesia.com.ponents.events.ComponentEvent.SELECTED_CHANGE
	 */
	[Event(name="selectedChange", type="aesia.com.ponents.events.ComponentEvent")]
	/**
	 ...
	 *  @see aesia.com.ponents.actions.Action
	 */
