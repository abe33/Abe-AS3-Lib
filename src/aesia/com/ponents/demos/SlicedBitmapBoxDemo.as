package aesia.com.ponents.demos 
{
	...
	public class SlicedBitmapBoxDemo extends Sprite 
	{
		...
		public function SlicedBitmapBoxDemo ()
		{
			...
			var s9b : SlicedBitmapFill = new SlicedBitmapFill(bgBitmap, new Rectangle( 8,8,24,24 ) );
